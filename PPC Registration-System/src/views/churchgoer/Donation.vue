...
<v-app>
  ...
  <v-container fluid >
    <v-row style="width:200px; ">
      <v-col >
        <v-list-subheader style="width:200px; ">Youth Department</v-list-subheader>
      </v-col>
    ...
    <v-row style="width:350px; ">
      <v-col cols="4">
        <v-list-subheader style="width:250px; ">Men's Ministry</v-list-subheader>
      </v-col>
    ...
    <v-row style="width:350px; ">
      <v-col cols="4">
        <v-list-subheader style="width:200px; ">Children's Ministry</v-list-subheader>
      </v-col>
    ...
    <v-row style="width:350px; " >
      <v-col cols="4">
        <v-list-subheader style="width:200px; ">Church Building</v-list-subheader>
      </v-col>
    ...
    <v-row style="width:350px; ">
      <v-col cols="4">
        <v-list-subheader style="width:200px; ">Others(Specify)</v-list-subheader>
      </v-col>
      ...
      <v-col cols="8">
       ...
       <v-btn
         style="width:250px; margin-left: 100px; margin-top:30px;"
